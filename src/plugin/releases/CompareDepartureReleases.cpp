...
namespace UKControllerPlugin::Releases {
    bool CompareDepartureReleases::operator()(const std::shared_ptr<DepartureReleaseRequest>& request, int id) const
    {
        return request->Id() < id;
    }

    bool CompareDepartureReleases::operator()(int id, const std::shared_ptr<DepartureReleaseRequest>& request) const
    {
