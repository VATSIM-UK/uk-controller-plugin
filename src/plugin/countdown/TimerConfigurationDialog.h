    ...
    namespace Countdown {
        ...
        */
        class TimerConfigurationDialog
        {
            ...
            void
            InitTimerRow(HWND hwnd, unsigned int timerId, unsigned int enabledCheckboxId, unsigned int durationBoxId);
            void
            SaveTimerRow(HWND hwnd, unsigned int timerId, unsigned int enabledCheckboxId, unsigned int durationBoxId);
