...
namespace UKControllerPlugin {
    namespace Countdown {
        TimerConfigurationDialog::TimerConfigurationDialog(
            UserSetting& userSettings, const UserSettingAwareCollection& userSettingHandlers)
        ...
        */
        LRESULT TimerConfigurationDialog::WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
        {
            ...
            TimerConfigurationDialog* dialog =
                reinterpret_cast<TimerConfigurationDialog*>(GetWindowLongPtr(hwnd, GWLP_USERDATA));
        ...
        */
        ...
        {
            this->InitTimerRow(hwnd, 1, TIMER1_ENABLED_CHECK, TIMER1_EDIT_DURATION);

            this->InitTimerRow(hwnd, 2, TIMER2_ENABLED_CHECK, TIMER2_EDIT_DURATION);

            this->InitTimerRow(hwnd, 3, TIMER3_ENABLED_CHECK, TIMER3_EDIT_DURATION);

            this->InitTimerRow(hwnd, 4, TIMER4_ENABLED_CHECK, TIMER4_EDIT_DURATION);

            this->InitTimerRow(hwnd, 5, TIMER5_ENABLED_CHECK, TIMER5_EDIT_DURATION);
        }
        ...
        */
        ...
        {
            this->SaveTimerRow(hwnd, 1, TIMER1_ENABLED_CHECK, TIMER1_EDIT_DURATION);

            this->SaveTimerRow(hwnd, 2, TIMER2_ENABLED_CHECK, TIMER2_EDIT_DURATION);

            this->SaveTimerRow(hwnd, 3, TIMER3_ENABLED_CHECK, TIMER3_EDIT_DURATION);

            this->SaveTimerRow(hwnd, 4, TIMER4_ENABLED_CHECK, TIMER4_EDIT_DURATION);

            this->SaveTimerRow(hwnd, 5, TIMER5_ENABLED_CHECK, TIMER5_EDIT_DURATION);
        ...
        */
        void TimerConfigurationDialog::InitTimerRow(
            HWND hwnd, unsigned int timerId, unsigned int enabledCheckboxId, unsigned int durationBoxId)
        {
            CheckDlgButton(
                hwnd,
                enabledCheckboxId,
            ...
            SendDlgItemMessage(
                ...
                reinterpret_cast<LPARAM>(
                    std::to_wstring(this->userSettings.GetUnsignedIntegerEntry(GetTimerDurationKey(timerId), 60))
                        .c_str()));

            SendDlgItemMessage(hwnd, durationBoxId, EM_SETLIMITTEXT, 4, NULL);
        }
        ...
        */
            ...
            HWND hwnd, unsigned int timerId, unsigned int enabledCheckboxId, unsigned int durationBoxId)
        {
            ...
            TCHAR buffer[5];
            LRESULT valid = SendDlgItemMessage(hwnd, durationBoxId, WM_GETTEXT, 6, reinterpret_cast<LPARAM>(buffer));
            ...
            if (timerDuration > 3600) {
                LogWarning(
                    "Invalid timer duration " + std::to_string(timerDuration) + " for timer #" +
            ...
            this->userSettings.Save(GetTimerDurationKey(timerId), GetTimerDurationDescription(timerId), timerDuration);
        }
    } // namespace Countdown
} // namespace UKControllerPlugin
