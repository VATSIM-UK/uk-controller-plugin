...
namespace UKControllerPlugin::IntentionCode
{
    ...
    */
    ...
    {
        public:
            void AddCacheEntry(std::shared_ptr<AircraftFirExit> entry);
            [[nodiscard]] auto GetCacheEntryForCallsign(const std::string& callsign) const -> std::shared_ptr<AircraftFirExit>;
            ...
            */
            [[nodiscard]] auto Generate(Euroscope::EuroScopeCFlightPlanInterface& flightplan) -> std::shared_ptr<AircraftFirExit> override;
