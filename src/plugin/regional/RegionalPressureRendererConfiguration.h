    ...
    namespace Regional {
        ...
        */
        class RegionalPressureRendererConfiguration
        {
            ...
            typedef std::set<UKControllerPlugin::Regional::RegionalPressureRenderedItem> RegionalPressureRenderedItems;
            ...
            const UKControllerPlugin::Regional::RegionalPressureRenderedItem invalidItem = {-9999, ""};
