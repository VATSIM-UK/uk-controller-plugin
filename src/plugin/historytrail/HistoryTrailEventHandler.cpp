...
namespace UKControllerPlugin {
    namespace HistoryTrail {
        ...
        HistoryTrailEventHandler::HistoryTrailEventHandler(HistoryTrailRepository& repository) : repository(repository)
        {
        }
        ...
        */
        void
        HistoryTrailEventHandler::ControllerFlightPlanDataEvent(EuroScopeCFlightPlanInterface& flightPlan, int dataType)
        {
        }
        ...
        */
        ...
        void HistoryTrailEventHandler::RadarTargetPositionUpdateEvent(EuroScopeCRadarTargetInterface& radarTarget)
        {
            ...
            this->repository.GetAircraft(radarTarget.GetCallsign())
                ->AddItem({radarTarget.GetHeading(), radarTarget.GetPosition()});
        }
    } // namespace HistoryTrail
} // namespace UKControllerPlugin
