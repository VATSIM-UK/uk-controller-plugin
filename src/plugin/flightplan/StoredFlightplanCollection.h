    ...
    namespace Flightplan {
        ...
        */
        class StoredFlightplanCollection
        {
            ...
            typedef std::map<std::string, std::unique_ptr<UKControllerPlugin::Flightplan::StoredFlightplan>>
                FlightplanMap;
            typedef FlightplanMap::iterator iterator;
            typedef FlightplanMap::const_iterator const_iterator;
            iterator begin(void)
            {
                return flightplans.begin();
            }
            iterator end(void)
            {
                return flightplans.end();
            }
            const_iterator cbegin() const
            {
                return flightplans.cbegin();
            }
            const_iterator cend() const
            {
                return flightplans.cend();
            }
