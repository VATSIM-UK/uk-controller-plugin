...
class EuroscopePluginLoopbackInterface
{
    public:
        ...
        virtual std::shared_ptr<EuroScopeCControllerInterface> GetUserControllerObject(
            void
        ) const = 0;
        ...
        virtual std::shared_ptr<EuroScopeCFlightPlanInterface> GetFlightplanForCallsign(
            std::string callsign
        ) const = 0;
