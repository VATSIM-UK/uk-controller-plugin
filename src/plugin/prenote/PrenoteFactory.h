...
namespace UKControllerPlugin::Prenote {
    ...
    */
    class PrenoteFactory
    {
        ...
        [[nodiscard]] auto CreateFromJson(const nlohmann::json& json) const
            -> std::unique_ptr<UKControllerPlugin::Prenote::AbstractPrenote>;

        private:
        [[nodiscard]] auto CreateAirfieldPairingPrenote(const nlohmann::json& json) const
            -> std::unique_ptr<UKControllerPlugin::Prenote::AirfieldPairingPrenote>;

        [[nodiscard]] auto CreateDeparturePrenote(const nlohmann::json& json) const
            -> std::unique_ptr<UKControllerPlugin::Prenote::DeparturePrenote>;
