    ...
    namespace MinStack {
        ...
        */
        void MinStackRenderer::AsrLoadedEvent(UserSetting& userSetting)
        {
            ...
            for (std::vector<std::string>::const_iterator it = selectedMinStacks.cbegin();
        ...
        */
        ...
        {
            userSetting.Save(
                this->visibleUserSettingKey, this->visibleUserSettingDescription, this->config.ShouldRender());
            userSetting.Save(
                this->xPositionUserSettingKey, this->xPositionUserSettingDescription, this->topBarArea.left);
            userSetting.Save(
                this->yPositionUserSettingKey, this->yPositionUserSettingDescription, this->topBarArea.top);

            std::vector<std::string> selectedMinStacks;
            for (MinStackRendererConfiguration::const_iterator it = this->config.cbegin(); it != this->config.cend();
                 ++it) {
        ...
        */
        ...
        {
            this->dialogManager.OpenDialog(IDD_MINSTACK, reinterpret_cast<LPARAM>(&this->config));
        }
        ...
        */
        int
        MinStackRenderer::RenderMinStacks(GdiGraphicsInterface& graphics, EuroscopeRadarLoopbackInterface& radarScreen)
        {
            // Loop through each of the TMAs
            Gdiplus::Rect tma = {
                this->topBarArea.left, this->topBarArea.bottom, this->leftColumnWidth, this->rowHeight};
            Gdiplus::Rect msl = {
        ...
        */
        void
        MinStackRenderer::RenderTopBar(GdiGraphicsInterface& graphics, EuroscopeRadarLoopbackInterface& radarScreen)
        {
        ...
        */
        ...
        {
            this->Move({100, 100, 100 + this->leftColumnWidth, 100 + this->rowHeight}, "");
        }
