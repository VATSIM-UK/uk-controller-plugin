...
namespace UKControllerPlugin {
    namespace Plugin {
        ...
        */
        class ForceUpdate : public RadarScreen::ConfigurableDisplayInterface, public Command::CommandHandlerInterface
        {
            public:
            ForceUpdate(Windows::WinApiInterface& winApi, int menuCallbackId);
