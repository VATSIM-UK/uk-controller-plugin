    ...
    namespace Windows {
        ...
        */
        ...
        public:
            ...
            virtual void OpenGeneralSettingsDialog(UKControllerPlugin::Euroscope::UserSetting & setting) const = 0;
            virtual void OpenMessageBox(LPCWSTR message, LPCWSTR title, int options) = 0;
