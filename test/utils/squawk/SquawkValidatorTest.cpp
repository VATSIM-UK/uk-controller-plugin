...
namespace UKControllerPluginTest::Squawk {
    ...
    TEST(SquawkValidator, AllowedSquawkReturnsFalseOn0000)
    {
        EXPECT_FALSE(SquawkValidator::AllowedSquawk("0000"));
    }

    TEST(SquawkValidator, AllowedSquawkReturnsFalseOn1234)
    {
        EXPECT_FALSE(SquawkValidator::AllowedSquawk("1234"));
    }
} // namespace UKControllerPluginTest::Squawk
