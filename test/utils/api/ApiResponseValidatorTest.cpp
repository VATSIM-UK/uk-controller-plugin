...
namespace UKControllerPluginUtilsTest {
    namespace Api {
        ...
        {
            EXPECT_FALSE(
                ApiResponseValidator::ValidateSchema("{\"test\": 12}"_json, {{"test", ApiResponseValidator::boolean}}));
        }

        TEST(ApiResponseValidator, ValidateSchemaFailsIfObjectNoMatch)
        {
            EXPECT_FALSE(
                ApiResponseValidator::ValidateSchema("{\"test\": 12}"_json, {{"test", ApiResponseValidator::object}}));
        }

        TEST(ApiResponseValidator, ValidateSchemaFailsIfFloatNoMatch)
        {
            EXPECT_FALSE(ApiResponseValidator::ValidateSchema(
        ...
        {
            EXPECT_FALSE(
                ApiResponseValidator::ValidateSchema("{\"test\": 12}"_json, {{"test", ApiResponseValidator::string}}));
        }
        ...
        {
            EXPECT_TRUE(ApiResponseValidator::ValidateSchema(
        ...
        {
            EXPECT_TRUE(ApiResponseValidator::ValidateSchema(
                "{\"test\": false, \"test2\": 1234}"_json,
                {{"test", ApiResponseValidator::boolean}, {"test2", ApiResponseValidator::integer}}));
        }
        ...
        TEST(ApiResponseValidator, ValidateSchemaCanHandleMissingKeys)
        {
            EXPECT_FALSE(ApiResponseValidator::ValidateSchema(
                "{\"test\": false, \"test2\": 1234}"_json,
                {{"test", ApiResponseValidator::boolean},
