...
namespace UKControllerPluginTest {
    namespace SectorFile {
            ...
            public:
                ...
                void SetUpDefaultElements(void)
                {
                    ...
                    ON_CALL(*element1, Name())
                        .WillByDefault(Return("EGKK London Gatwick 08R - 26L"));
                    ...
                    ON_CALL(*element1, Runway1Identifier())
                        .WillByDefault(Return("08R"));

                    ON_CALL(*element1, Runway2Identifier())
                        .WillByDefault(Return("26L"));
        ...
        TEST_F(RunwayCollectionTest, ItUpdatesRunwayActivity)
        {
            ...
            ON_CALL(*element, Airport())
                .WillByDefault(Return("EGKK - London Gatwick"));

            ON_CALL(*element, Name())
                .WillByDefault(Return("EGKK London Gatwick 08R - 26L"));

            EXPECT_CALL(*element, Runway1ActiveForDepartures())
                .Times(2)
                .WillOnce(Return(true))
                .WillOnce(Return(false));

            EXPECT_CALL(*element, Runway1ActiveForArrivals())
                .Times(2)
                .WillOnce(Return(true))
                .WillOnce(Return(false));

            EXPECT_CALL(*element, Runway2ActiveForDepartures())
                .Times(2)
                .WillOnce(Return(false))
                .WillOnce(Return(true));

            EXPECT_CALL(*element, Runway2ActiveForArrivals())
                .Times(2)
                .WillOnce(Return(false))
                .WillOnce(Return(true));

            ON_CALL(*element, Runway1ActiveForDepartures())
                .WillByDefault(Return(false));

            ON_CALL(*element, Runway1ActiveForArrivals())
                .WillByDefault(Return(false));

            ON_CALL(*element, Runway2ActiveForDepartures())
                .WillByDefault(Return(true));

            ON_CALL(*element, Runway2ActiveForArrivals())
                .WillByDefault(Return(true));

            ON_CALL(*element, Runway1Heading())
                .WillByDefault(Return(81));

            ON_CALL(*element, Runway2Heading())
                .WillByDefault(Return(259));

            ON_CALL(*element, Runway1Identifier())
                .WillByDefault(Return("08R"));

            ON_CALL(*element, Runway2Identifier())
                .WillByDefault(Return("26L"));
