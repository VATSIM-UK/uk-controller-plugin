...
namespace UKControllerPluginTest {
    namespace Function {
        ...
        {
            CallbackFunction first = { 1, "test", [](int, std::string test) {} };
            CallbackFunction second = { 1, "test2", [](int, std::string test) {} };
        ...
        {
            CallbackFunction first = { 1, "test", [](int, std::string test) {} };
            CallbackFunction second = { 2, "test2", [](int, std::string test) {} };
        ...
        {
            int testCount = 0;
            CallbackFunction first = { 1, "test", [&testCount](int, std::string test) {testCount++; } };
