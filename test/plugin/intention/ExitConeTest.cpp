...
namespace UKControllerPluginTest::IntentionCode {
    class ExitConeTest : public testing::Test
    {
        public:
        ExitConeTest()
    ...
    TEST_F(ExitConeTest, AircraftIsNotExitingBeforeConeStart)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(99.0));
    ...
    TEST_F(ExitConeTest, AircraftIsNotExitingAfterConeEnd)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(201.0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingLowerBoundaryOfCone)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(100.0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingUpperBoundaryOfCone)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(200.0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingMiddleOfCone)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(150.0));
    ...
    TEST_F(ExitConeTest, AircraftIsNotExitingBeforeConeStartPastNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(339.0));
    ...
    TEST_F(ExitConeTest, AircraftIsNotExitingAfterConeEndPastNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(21));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingLowerBoundaryOfConePastNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(340.0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingUpperBoundaryOfConePastNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(20.0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingMiddleOfConePastNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingFullCircleGoingNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(360.0));
    ...
    TEST_F(ExitConeTest, AircraftIsExitingFullCircleNotNorth)
    {
        ...
        ON_CALL(*mockCoordinate, DirectionTo(testing::Ref(*mockCoordinate2))).WillByDefault(testing::Return(50));
