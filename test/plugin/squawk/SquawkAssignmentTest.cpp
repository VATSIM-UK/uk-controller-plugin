...
namespace UKControllerPluginTest {
    namespace Squawk {
        ...
        class SquawkAssignmentTest : public Test
        {
            ...
            {
                this->mockFlightplan =
                    std::shared_ptr<MockEuroScopeCFlightPlanInterface>(new NiceMock<MockEuroScopeCFlightPlanInterface>);
        ...
        {
            ON_CALL(*this->mockFlightplan, GetDistanceFromOrigin).WillByDefault(Return(0.0));
        ...
        TEST_F(SquawkAssignmentTest, LocalAssignmentUntrackedTooFastReturnFalse)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetDestination()).WillByDefault(Return("EGKK"));
        ...
        TEST_F(SquawkAssignmentTest, LocalAssignmentUntrackedAirfieldNowOwnedReturnFalse)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetOrigin()).WillByDefault(Return("EGGD"));

            ON_CALL(*this->mockFlightplan, GetDestination()).WillByDefault(Return("EGGD"));
        ...
        TEST_F(SquawkAssignmentTest, LocalAssignmentUntrackedVfrFlightReturnTrue)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetFlightRules()).WillByDefault(Return("V"));
        ...
        TEST_F(SquawkAssignmentTest, LocalAssignmentUntrackedNoSidLowFlightFlightReturnTrue)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetFlightRules()).WillByDefault(Return("I"));

            ON_CALL(*this->mockFlightplan, HasSid()).WillByDefault(Return(false));
        ...
        TEST_F(SquawkAssignmentTest, LocalAssignmentUntrackedNoSecondaryConditionReturnFalse)
        {
            ...
            ON_CALL(*this->mockFlightplan, HasSid()).WillByDefault(Return(true));
        ...
        TEST_F(SquawkAssignmentTest, ForceAssignmentReturnsTrueIfPlanDifferent)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetDestination()).WillByDefault(Return("EGPH"));
        ...
        TEST_F(SquawkAssignmentTest, ForceAssignmentReturnsFalseIfPlanSame)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetDestination()).WillByDefault(Return("EGBB"));
        ...
        TEST_F(SquawkAssignmentTest, CircuitAssignmentReturnsFalseOnNotVfr)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetRawRouteString()).WillByDefault(Return("CIRCUITS"));
        ...
        TEST_F(SquawkAssignmentTest, CircuitAssignmentReturnsTrueOnCircuit)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetRawRouteString()).WillByDefault(Return("CIRCUIT"));
        ...
        TEST_F(SquawkAssignmentTest, CircuitAssignmentReturnsTrueOnVfrCircuits)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetRawRouteString()).WillByDefault(Return("VFR CIRCUITS"));
        ...
        TEST_F(SquawkAssignmentTest, CircuitAssignmentDoesntAcceptCircuitsThatArentStartOfFlightplan)
        {
            ...
            ON_CALL(*this->mockFlightplan, GetRawRouteString()).WillByDefault(Return("CHEW VALLEY FROME VFR CIRCUITS"));
