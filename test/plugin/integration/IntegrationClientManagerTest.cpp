...
namespace UKControllerPluginTest::Integration {
    ...
    class IntegrationClientManagerTest : public Test
    {
        ...
        IntegrationClientManagerTest()
        {
            ...
            this->client1 = std::make_shared<IntegrationClient>(1, "1", "1", this->connection1);
            this->client2 = std::make_shared<IntegrationClient>(2, "2", "2", this->connection2);
    ...
    TEST_F(IntegrationClientManagerTest, ItRemovesAllInactiveClients)
    {
        ...
        ON_CALL(*this->mockConnection1, Active).WillByDefault(testing::Return(false));

        ON_CALL(*this->mockConnection2, Active).WillByDefault(testing::Return(false));
    ...
    TEST_F(IntegrationClientManagerTest, ItRemovesSingleInactiveClients)
    {
        ...
        ON_CALL(*this->mockConnection2, Active).WillByDefault(testing::Return(true));
