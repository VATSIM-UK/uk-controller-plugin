...
namespace UKControllerPluginTest {
    namespace Controller {
        ...
        class LoginTest : public Test
        {
            public:
                LoginTest()
                    : login(this->mockLoopback, this->collection)
                {

                }

                NiceMock<MockEuroscopePluginLoopbackInterface> mockLoopback;
        ...
        TEST_F(LoginTest, DefaultsLoginTime) {
            EXPECT_EQ(this->login.defaultLoginTime, this->login.GetLoginTime());
        }
        ...
        TEST_F(LoginTest, SetsLoginTimeIfDirectLogin) {
            ...
            EXPECT_NE(this->login.GetLoginTime(), this->login.defaultLoginTime);
        }
        ...
        TEST_F(LoginTest, DoesNotSetLoginTimeIfViaProxy) {
            ...
            this->login.TimedEventTrigger();
            EXPECT_EQ(this->login.GetLoginTime(), this->login.defaultLoginTime);
        }
