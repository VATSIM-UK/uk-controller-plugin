...
namespace UKControllerPluginTest::Controller {
    ...
    class ActiveCallsignCollectionTest : public Test
    {
        ...
        ActiveCallsignCollectionTest()
            : testPosition(1, "LON_S_CTR", 129.420, {}, true, false),
              testCallsign("LON_S_CTR", "Testy Boi", testPosition, true)
        {
    ...
    TEST_F(ActiveCallsignCollectionTest, ItHandlesNewCallsignEvents)
    {
        ...
        EXPECT_CALL(*this->handler1, ActiveCallsignAdded(this->testCallsign)).Times(1);
        EXPECT_CALL(*this->handler2, ActiveCallsignAdded(this->testCallsign)).Times(1);
    ...
    TEST_F(ActiveCallsignCollectionTest, ItHandlesRemovedCallsignEvents)
    {
        ...
        EXPECT_CALL(*this->handler1, ActiveCallsignRemoved(this->testCallsign)).Times(1);
        EXPECT_CALL(*this->handler2, ActiveCallsignRemoved(this->testCallsign)).Times(1);
    ...
    {
        ActiveCallsign cs1("LON_S1_CTR", "Bob Jones", this->testPosition, true);
        ActiveCallsign cs2("LON_S__CTR", "Jones Bob", this->testPosition, true);
    ...
    {
        ActiveCallsign callsign("LON_S_CTR", "Testy McTest", this->testPosition, true);
        ActiveCallsign callsign2("LON_S1_CTR", "Testy McTest", this->testPosition, true);
    ...
    TEST_F(ActiveCallsignCollectionTest, FlushEmptiesTheCollection)
    {
        ...
        ActiveCallsign cs1("LON_S_CTR", "Bob Jones", controller1, true);
        ActiveCallsign cs2("LON_C_CTR", "Jones Bob", controller2, true);
        ActiveCallsign cs3("LON_E_CTR", "Jimbob Jump", controller3, true);
    ...
    TEST_F(ActiveCallsignCollectionTest, RemoveCallsignDoesNotChangeUserIfNotUserLoggingOff)
    {
        ...
        ActiveCallsign callsign2("LON_E_CTR", "Testy McTestingon", pos2, true);
        collection.AddUserCallsign(this->testCallsign);
    ...
    TEST_F(ActiveCallsignCollectionTest, CorrectlyHandlesMismatchingCallsigns)
    {
        ...
        ActiveCallsign callsign("LON_S_CTR", "Testy McTest", pos2, true);
        collection.AddUserCallsign(callsign);
