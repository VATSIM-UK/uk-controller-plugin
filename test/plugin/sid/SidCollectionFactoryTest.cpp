...
namespace UKControllerPluginTest {
    namespace Sid {
        ...
        TEST_F(SidCollectionFactoryTest, MakeSidCollectionCreatesSids)
        {
            ...
            std::shared_ptr<StandardInstrumentDeparture> sid1 = collection->
                GetByAirfieldAndIdentifier("EGGD", "TEST1Y");
            ...
            std::shared_ptr<StandardInstrumentDeparture> sid2 = collection->
                GetByAirfieldAndIdentifier("EGLL", "TEST1Z");
